...
def read_dict_table(read_conn_fig, write_conn_fig, date):
    ...
    read_custom_url_collect(
        read_conn, write_conn, sql_code.sql_dict_update_templatemessage, write_db_name, 'templatemessage', date
    )
    read_custom_url_collect(
        read_conn, write_conn, sql_code.sql_dict_update_mp_send, write_db_name, 'mp_send', date
    )
    read_conn.close()
    write_conn.close()
