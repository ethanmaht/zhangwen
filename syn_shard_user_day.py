...
if __name__ == '__main__':
    ...
    """ ****** ↓ 有声 ↓ ****** """
    # syn_happy_seven_sound_shard_work('2021-06-01')  # 有声的数据库同步 -> .1h
    # es_tool.run_read_ex_loop(
    #     sub_days=2, size=10000, write_conn_fig='datamarket_out', write_db='sound', tab='es_log'
    # )  # 有声的es同步 -> .1h
    # es_tool.run_read_one_book_loop(
    #     sub_days=2, size=10000, write_conn_fig='datamarket', write_db='one_book_read', tab='read_log'
    # )
